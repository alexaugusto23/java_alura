...
public class CalculaIRPF {
	...
	if (salario >= 1903.98 && salario <= 2826.65) {
		...
		System.out.println("O IR é de 7.5% e pode deduzir na declaração o valor de R$ " + deducao);}
	else if (salario > 2826.65 && salario <= 3751.05) {
		deducao = deducao + salario * percentual_ir_quinze;
		System.out.println("O IR é de 15% e pode deduzir R$ " + deducao);}
	else if (salario > 3751.05 && salario <= 4664.68) {
		deducao = salario * percentual_ir_vintedois_e_meio;
		System.out.println("O IR é de 22.5% e pode deduzir R$ " + deducao);}
	else if (salario > 4664.68) {
		deducao = salario * percentual_ir_vintesete_e_meio;
		System.out.println("O IR é de 27.5% e pode deduzir R$ " + deducao);}
