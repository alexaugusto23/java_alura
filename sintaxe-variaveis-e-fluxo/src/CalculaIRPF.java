...
public class CalculaIRPF {
	...
	if (salario >= 1903.98 && salario <= 2826.65) {
		...
		System.out.println("O IR é de 7.5% e pode deduzir na declaração o valor de R$ " + deducao + " e imposto: " + imposto);}
	
	else if (salario > 2826.65 && salario <= 3751.05) {
		double deducao = 354.80;
		imposto = (salario * percentual_ir_quinze) - deducao;
		System.out.println("O IR é de 15% e pode deduzir R$ " + deducao + " e imposto: " + imposto);}
	
	else if (salario > 3751.05 && salario <= 4664.68) {
		double deducao = 636.13;
		imposto = (salario * percentual_ir_vintedois_e_meio) - deducao;
		System.out.println("O IR é de 22.5% e pode deduzir R$ " + deducao + " e imposto: " + imposto);}
	
	else if (salario > 4664.68) {
		double deducao = 869.36;
		imposto = (salario * percentual_ir_vintesete_e_meio) - deducao;
		System.out.println("O IR é de 27.5% e pode deduzir R$ " + deducao + " e imposto: " + imposto);}
	
	else {System.out.println("Você é isento!!!");}
